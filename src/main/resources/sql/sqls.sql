create table if not exists calculation_info
(
	name char(20) default '0' not null
		primary key,
	proportion double default 0 not null
);
...
(
	...
	constraint time_sheet_employee_information__fk
		foreign key (id) references employee_information (id)
);
